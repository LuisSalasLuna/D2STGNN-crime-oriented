...
# TensorBoard
writer = SummaryWriter('runs/D2STGN174_new')
...
# ========================== load dataset, adjacent matrix, node embeddings ====================== #
    if load_pkl: #Realmente utiliza el pickle?
        t1   = time.time()
...
# =============================================================== Validation ================================================================= #
            ...
            writer.add_scalar('Training MAE', mtrain_loss, global_step=step) #Review
            writer.add_scalar('Training MAPE', mtrain_mape, global_step=step) #Review
            writer.add_scalar('Training RMSE', mtrain_rmse, global_step=step) #Review
            writer.add_scalar('Validarion MAE', mvalid_loss, global_step=step) #Review
            writer.add_scalar('Validation MAPE', mvalid_mape, global_step=step) #Review
            writer.add_scalar('Validation RMSE', mvalid_rmse, global_step=step) #Review
            step+=1
